      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 py-3 flex items-center justify-between gap-2 sm:gap-4">
        <div className="flex items-center gap-3">
          <button onClick={() => onNavigate('dashboard')} className="flex items-center gap-3 cursor-pointer">
            <div className="w-9 h-9 rounded-xl flex items-center justify-center shadow-lg shadow-rose-400/20">
        ...
        <div className="flex items-center gap-2">
          {isPremium ? (
            <button
              ...
              className="flex items-center gap-1.5 px-3 py-1.5 rounded-lg text-[11px] font-medium bg-gradient-to-r from-rose-300/20 to-pink-400/20 text-rose-200 border border-rose-300/30 shadow-lg shadow-rose-400/10 hover:from-rose-300/30 hover:to-pink-400/30 transition-all cursor-pointer"
            >
