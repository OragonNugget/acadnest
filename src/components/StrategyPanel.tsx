...
export default function StrategyPanel({ strategies, isPremium, targetPossible, externalSelectedId, onExternalSelectedClear }: Props) {
  ...
  if (!isPremium) {
    return (
      <div className="rounded-2xl bg-gradient-to-br from-yellow-300/[0.03] to-amber-300/[0.02] border border-yellow-300/[0.1] p-6">
        ...
        <p className="text-[11px] text-yellow-300/40 mt-4 text-center">Upgrade to Premium to access strategies</p>
      </div>
    );
  }
                  ...
                  <div key={i} className="flex items-center gap-3 px-3 py-2.5 rounded-lg bg-white/[0.02]">
                    <div className="flex-1 min-w-0">
                      ...
                      <div className="flex items-center gap-2">
                        ...
                        <ArrowUpRight className="w-3 h-3 text-yellow-300/50" />
