    ...
    <form onSubmit={handleSubmit} className="rounded-xl bg-white/[0.03] border border-white/[0.08] p-4">
      ...
      <div className="flex gap-2 mt-3">
        <button
          ...
          className="px-4 py-2 rounded-lg bg-yellow-300/20 text-yellow-200 text-sm font-medium hover:bg-yellow-300/30 transition-colors cursor-pointer disabled:opacity-40 disabled:cursor-not-allowed flex items-center gap-2"
        >
