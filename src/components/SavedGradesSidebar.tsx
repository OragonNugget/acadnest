...
export default function SavedGradesSidebar({
  ...
  return (
    ...
    >
      ...
      >
        <BookMarked className="w-4 h-4 text-yellow-300/60" />
                ...
                >
                  ...
                  {activeGradeId === grade.id && (
                    <button
                      ...
                      className="text-white/20 hover:text-yellow-300 cursor-pointer opacity-0 group-hover:opacity-100 transition-opacity"
                      title="Update save"
                    >
              ...
              {showSaveForm ? (
                <div className="flex gap-2 items-center bg-white/[0.02] rounded-lg p-2">
                  <input
                    ...
                    autoFocus
                  />
                  <button onClick={handleSave} className="text-[10px] text-yellow-200 hover:text-yellow-100 cursor-pointer">Save</button>
