                ...
                <div className="flex flex-wrap gap-2 items-end bg-white/[0.02] rounded-lg p-3">
                  <div>
                    ...
                    <input
                      ...
                      className="bg-white/[0.06] border border-white/[0.08] rounded px-2 py-1 text-xs text-white w-24 focus:outline-none focus:border-amber-400/40"
                    />
                  </div>
                  <div>
                    ...
                    <input
                      ...
                      min={0}
                      placeholder="85"
                      className="bg-white/[0.06] border border-white/[0.08] rounded px-2 py-1 text-xs text-white w-16 focus:outline-none focus:border-amber-400/40"
                      autoFocus
                    />
                  </div>
                  <div>
                  ...
                  <button onClick={handleAddEntry} className="px-3 py-1 rounded-md bg-amber-400/20 text-amber-300 text-xs hover:bg-amber-400/30 transition-colors cursor-pointer">Add</button>
