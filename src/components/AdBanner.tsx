...
const ads = {
  top: [
    ...
    { text: '🎓 CourseHero — Get 24/7 homework help from tutors', sub: 'First month 50% off', color: 'from-pink-500/20 to-red-600/10', borderColor: 'border-pink-400/15' },
  ],
  sidebar: [
  ...
  inline: [
    { text: '🚀 Acadnest Premium — Remove ads, unlock Grade Coach & strategies', sub: 'Upgrade now', color: 'from-rose-400/15 to-pink-400/8', borderColor: 'border-rose-400/15' },
  ],
};
