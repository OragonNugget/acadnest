...
const ads = {
  ...
  inline: [
    { text: '🚀 Trackademic Premium — Remove ads, unlock AI Coach & strategies', sub: 'Upgrade now', color: 'from-amber-500/15 to-orange-500/8', borderColor: 'border-amber-500/15' },
  ],
};
